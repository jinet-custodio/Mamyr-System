                                        ...
                                        ?>
                                            <div class="form-group other-container" id="otherInput">
                                                <?php foreach ($otherPartnerTypes as $val): ?>
                                                    <input type="text" class="form-control" name="other-partner-type[]" value="<?= htmlspecialchars($val) ?>">
                                                <?php endforeach; ?>
                                                <div class="button">
                                                    <!-- //TODO: Pakipalitan na lang -->
                                                    <button type="button" id="addInputField"><i class="bi bi-plus"></i> Add other</button>
                                                </div>
                                                <div class="button">
                                                    <button type="button" id="removeInputField"><i class="bi bi-x"></i> Remove field</button>
                                                </div>
                                            </div>
                                        <?php else: ?>
                ...
                cb.addEventListener("change", function() {
                    ...
                    if (labelText.toLowerCase() === "other") {
                        ...
                        if (this.checked) {
                            ...
                            otherInput.querySelectorAll('input[name="other-partner-type[]"]').forEach(input => input.value = '');
                        }
                    }
