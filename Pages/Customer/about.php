...
<body>
    ...
    <div class="aboutTopContainer" id="aboutTopContainer">
        ...
        <div class="topTextContainer">
            ...
            <p class="aboutDescription indent">
                <?= htmlspecialchars($contentMap['AboutMamyr'] ?? 'No description Not Found') ?></p>
    ...
    <div class="ourServicesContainer" id="ourServicesContainer">
        <div class="servicesTitleContainer">
            ...
            <p class="servicesDescription indent">
                <?= htmlspecialchars($contentMap['ServicesDesc'] ?? 'No description Not Found') ?></p>
        </div>
        ...
        <div class="servicesIconContainer">
            ...
            <div class="resortContainer">
                ...
                <p class="resortIconDescription">
                    <?= htmlspecialchars($contentMap['Service1Desc'] ?? 'No description Not Found') ?></p>
            </div>
            ...
            <div class="eventContainer">
                ...
                <p class="eventIconDescription">
                    <?= htmlspecialchars($contentMap['Service2Desc'] ?? 'No description Not Found') ?></p>
            </div>
            ...
            <div class="hotelContainer">
                ...
                <p class="hotelIconDescription">
                    <?= htmlspecialchars($contentMap['Service3Desc'] ?? 'No description Not Found') ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="videoContainer" id="videoContainer">
        <div class="videoTextContainer">
            ...
            ?>
            <h3 class="videoTitle">Explore
                <?= htmlspecialchars($businessInfo['FullName'] ?? 'No description Not Found') ?></h3>

            <p class="videoDescription indent">
                <?= htmlspecialchars($contentMap['Explore'] ?? 'No description Not Found') ?></p>
        </div>
    ...
    <div class="mamyrHistoryContainer" id="mamyrHistoryContainer">
        <div class="firstParagraphContainer">
            <div class="firstParagraphtextContainer">
                <p class="firstParagraph indent">
                    <?= htmlspecialchars($contentMap['HistoryParagraph1'] ?? 'No description Not Found') ?></p>

                <p class="secondParagraph indent">
                    <?= htmlspecialchars($contentMap['HistoryParagraph2'] ?? 'No description Not Found') ?>
            </div>
        ...
        <div class="thirdParagraphContainer">
            ...
            <div class="thirdParagraphtextContainer">
                <p class="thirdParagraph indent">
                    <?= htmlspecialchars($contentMap['HistoryParagraph3'] ?? 'No description Not Found') ?>
                </p>
            </div>
        </div>
        ...
        <div class="fourthParagraphContainer">
            <p class="fourthParagraph indent">
                <?= htmlspecialchars($contentMap['HistoryParagraph4'] ?? 'No description Not Found') ?>
            </p>
        </div>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            readMoreBtn.addEventListener('click', function() {
                if (mamyrHistoryContainer.style.display == "none" && backArrowContainer.style.display ==
                    "none") {
