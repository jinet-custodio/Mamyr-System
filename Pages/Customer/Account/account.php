        ...
        <div class="bookings">
            <table class="table table-striped " id="bookingTable">
                ...
                <tbody>
                    <!-- Select booking info -->
                    <?php
                    $selectQuery = "SELECT ps.PBName, rs.RScategoryID , 
                    ec.categoryName, b.*, stat.statusName AS status,
                    s.resortServiceID AS resort, 
                    s.partnershipServiceID AS partner, 
                    s.swimmingID AS swimming
                FROM bookings b
                ...
                WHERE b.userID = '$userID'";
                    ...
                    ?>
                            <tr>
                                ...
                                <?php
                                if (!empty($bookings['serviceID'])) {
                                    if (empty($bookings['resort']) && empty($bookings['partner']) && !empty($bookings['swimming'])) {
                                ?>
                                        <td>Swimming</td>
                                    <?php
                                    } else {
                                    ...
                                    ?>
                                <?php
                                } elseif (!empty($bookings['packageID'])) {
                                ?>
                                    <td><?= $bookings['categoryName'] ?></td>
                                <?php
                                } elseif (!empty($bookings['customePackageID'])) {
                                ?>
                                ...
                                <td>
                                    ...
                                    ?>
                                        <span class="badge bg-warning text-dark"> <?= $bookings['status'] ?></span>
                                    ...
                                    ?>
                                        <span class="badge rounded-pill bg-danger"> <?= $bookings['status'] ?></span>
                                    <?php
                                    } elseif ($bookings['status'] == "Rejected") {
                                    ?>
                                        <span class="badge rounded-pill bg-secondary"> <?= $bookings['status'] ?></span>
                                    <?php
                                    }
                                    ?>
                                </td>
