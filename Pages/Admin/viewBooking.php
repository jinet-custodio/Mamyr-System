    ...
    <div class="guest-container">
        ...
        <div class="card">
            <form action="../../Function/Admin/bookingApproval.php" method="POST">
                ...
                ?>
                <!-- Reschedule Modal -->
                <div class="modal fade" id="reschedModal" tabindex="-1" aria-labelledby="reschedModalLabel"
                    aria-hidden="true">
                        ...
                        <div class="modal-content">
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="newStartDateTime" class="form-control"
                                        name="newStartDateTime" placeholder="Select date & time">
                                </div>
                                <div class="mb-3">
                                    <label for="newDate" class="form-label">Select a New End Date</label>
                                    <input type="text" id="newEndDateTime" class="form-control" name="newEndDateTime"
                ...
                <!--  Charges Modal -->
                <div class="modal fade" id="chargesModal" tabindex="-1" aria-labelledby="chargesModal"
                    aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                        ...
                                        <div class="checkbox-group">
                                            ...
                                            <div class="form-check">
                                                ...
                                                <div class="additional-input gap-1" id="additional-bed-input"
                                                    ...
                                                    <div class="form-floating mb-1">
                                                        <input type="number" class="form-control" id="bed-quantity"
                                                            name="additionalCharges[bed][quantity]" value=""
                                                            data-role="quantity">
                                                        <label for="bed-quantity">Quantity</label>
                                                    </div>
                                                    <div class="form-floating mb-1">
                                                        <input type="number" class="form-control" id="bed-amount"
                                                            data-role="amount" name="additionalCharges[bed][amount]">
                                                ...
                                                <div class="additional-input  gap-1" id="additional-kitchenware-input"
                                                    ...
                                                    <div class="form-floating mb-1">
                                                        <input type="number" class="form-control"
                                                            id="kitchenware-quantity"
                                                            name="additionalCharges[kitchenware][quantity]"
                                                            data-role="quantity">
                                                        <label for="kitchenware-quantity">Quantity</label>
                                                    </div>
                                                    <div class="form-floating mb-1">
                                                        <input type="number" class="form-control"
                                                            id="kitchenware-amount"
                                                            name="additionalCharges[kitchenware][amount]"
                                                            data-role="amount">
                                            ...
                                            <div class="form-check">
                                                ...
                                                <div class="additional-input efan  gap-1" id="electric-fan-input"
                                                    ...
                                                    <div class="form-floating mb-1">
                                                        <input type="number" class="form-control"
                                                            id="electricFan-quantity"
                                                            name="additionalCharges[fan][quantity]"
                                                            data-role="quantity">
                                                        <label for="electric-fan-quantity">Quantity</label>
                                                    </div>
                                                    <div class="form-floating mb-1">
                                                        <input type="number" class="form-control"
                                                            id="electricFan-amount"
                                                            name="additionalCharges[fan][amount]" data-role="amount">
                                            ...
                                            <div class="form-check">
                                                ...
                                                <!-- Additional Input for Quality and Charge -->
                                                <div class="additional-input  gap-1" id="table-input"
                                                    style="display: none;">
                                                    <div class="form-floating mb-1">
                                                        <input type="number" class="form-control" id="table-quantity"
                                                            name="additionalCharges[table][quantity]"
                                                            data-role="quantity">
                                                        <label for="table-quantity">Quantity</label>
                                                    </div>
                                                    <div class="form-floating mb-1">
                                                        <input type="number" class="form-control" id="table-amount"
                                                            name="additionalCharges[table][amount]" data-role="amount">
                                                ...
                                                <div class="additional-input  gap-1" id="additional-person-input"
                                                    ...
                                                    <div class="form-floating mb-1">
                                                        <input type="number" class="form-control" id="person-quantity"
                                                            name="additionalCharges[person][quantity]"
                                                            data-role="quantity">
                                                        <label for="kitchenware-quantity">Quantity</label>
                                                    </div>
                                                    <div class="form-floating mb-1">
                                                        <input type="number"" class=" form-control" id="person-amount"
                                                            name="additionalCharges[person][amount]" data-role="amount">
                                                        <label for="kitchenware-amount">Amount</label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-check">
                                                ...
                                                <div class="additional-input" id="others-input" style="display: none;">
                                                    <div class="form-floating mb-1">
                                                        <input type="text" class="form-control" id="other-desc"
                                                            name="additionalCharges[others][name]" data-role="name">
                                                        <label for="other-name">Description</label>
                                                    </div>
                                                    <div class="form-floating mb-1">
                                                        <input type="number" class="form-control" id="other-quantity"
                                                            name="additionalCharges[others][quantity]"
                                                            data-role="quantity">
                                                        <label for="other-quantity">Quantity</label>
                                                    </div>
                                                    <div class="form-floating mb-1">
                                                        <input type="number" class="form-control" id="other-amount"
                                                            name="additionalCharges[others][amount]" data-role="amount">
                ...
                <div class="card" id="info-card">
                    ...
                    <div class="paymentDetails">
                        <div class="payment-body">
                            ...
                            <div class="addCharges-container">
                                <button type="button" class="btn btn-success approveReject addCharges"
                                    data-bs-toggle="modal" data-bs-target="#chargesModal">Add Charges</button>
                            </div>
                        </div>
