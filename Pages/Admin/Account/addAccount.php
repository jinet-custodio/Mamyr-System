...
<head>
    ...
    <!-- CSS Link -->
    <link rel="stylesheet" href="../../../Assets/CSS/Admin/Account/addAccount.css" />
...
<body>
    ...
    <div class="wrapper">
        <form action="../../../Function/Admin/Account/addUser.php" method="POST" enctype="multipart/form-data">
            <div class="card">
