        ...
        <main class="main-content" id="main-content">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="addAccount.php" class="btn btn-light add-button"><img
                            src="../../Assets/Images/Icon/addUser.png" alt=""> Add an Account</a>
                </div>
                <div class="card-body">
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <p class="modal-text text-center mb-2">Deleting this account will remove all
                                            user access from the system. Their booking records will be retained for
                                            historical or reporting purposes, but personal identifiers (such as their
                                            name) will be removed. This action is permanent and cannot be undone.</p>
