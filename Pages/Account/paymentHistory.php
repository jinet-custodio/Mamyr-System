            ...
            <div class="modal fade" id="view-dp" aria-hidden="true" aria-labelledby="exampleModalToggleLabel2"
                ...
                <div class="modal-dialog  modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <img src="" alt="Downpayment Image" id="payment-preview" class="downpaymentPic mb-3">
                        </div>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        document.addEventListener("click", function(e) {
            if (e.target && e.target.classList.contains("viewPaymentInfo")) {
                ...
                viewPaymentModal.querySelector('#rate-modal-header .modal-title').innerHTML =
                    `Payment Details &mdash; <strong> ${booking.bookingCode} </strong>`;

                viewPaymentModal.querySelector('#booking-type').innerHTML =
                ...
                if (payments.length > 0) {
                    ...
                    payments.forEach((payment, i) => {
                        const downpaymentContainer = document.createElement(
                        ...
                        viewImage.querySelector('#payment-preview').src =
                            '../../Assets/Images/PaymentProof/' + payment.image;
                    });
                } else {
