        ...
        fetch(`../../Function/Partner/getPartnerServices.php?id=${encodeURIComponent(partnershipID)}`)
            ...
            .then(data => {
                ...
                services.forEach((service, index) => {
                    ...
                    infoContainer.appendChild(inputContainer('Service Name', 'serviceName', service
                        .serviceName));
                    infoContainer.appendChild(inputContainer('Service Price', 'servicePrice',
                        service.servicePrice));
                    infoContainer.appendChild(inputContainer('Service Capacity', 'serviceCapacity',
                        service.serviceCapacity));
                    infoContainer.appendChild(inputContainer('Service Duration', 'serviceDuration',
