        ...
        <main class="main-content" id="main-content">
            <div class="container">
                <div class="titleContainer">
                    <h2 class="page-title" id="title">Services</h2>
                </div>
                        ...
                        <div class="serviceInputContainer">
                            <div class="serviceNameContainer">
                                ...
                                <input type="text" class="form-control" id="serviceName" name="serviceName"
                                    ...
                                    value="<?= isset($_SESSION['addServiceForm']['serviceName']) ? $_SESSION['addServiceForm']['serviceName'] : '' ?>"
                                    required>
                            </div>
                            ...
                            <div class="AvailabilityContainer">
                                ...
                                <select class="form-select" name="serviceAvailability" id="serviceAvailability">
                                    <option value="" disabled
                                        <?= empty($_SESSION['addServiceForm']['serviceAvailability']) ? 'selected' : '' ?>>
                            ...
                            <div class="priceContainer">
                                ...
                                <input type="text" class="form-control" id="price" name="price" placeholder="e.g. 1000"
                                    value="<?= isset($_SESSION['addServiceForm']['price']) ? $_SESSION['addServiceForm']['price'] : '' ?>"
                                    required>
                            </div>
                            ...
                            <div class="capacityContainer">
                                ...
                                <input type="number" class="form-control" id="capacity" name="capacity"
                                    ...
                                    value="<?= isset($_SESSION['addServiceForm']['capacity']) ? $_SESSION['addServiceForm']['capacity'] : '' ?>">
                            </div>
                            ...
                            <div class="durationContainer">
                                ...
                                <input type="text" class="form-control" id="duration" name="duration"
                                    ...
                                    value="<?= isset($_SESSION['addServiceForm']['duration']) ? $_SESSION['addServiceForm']['duration'] : '' ?>">
                            </div>

                            <div class="descContainer">
                                <label for="description" class="description" class="addServiceLabel">Description</label>
                                <textarea id="description" name="serviceDesc" class=" serviceDesc form-control"
                            ...
                            <div class="service-image mt-2">
                                <div class="input-container">
                                    <label for="service-image" class="addServiceLabel ">Service
                                        Image</label>
                                    <input class="form-control" type="file" accept="image/png, image/jpeg"
                                        name="serviceImage" id="service-image">
